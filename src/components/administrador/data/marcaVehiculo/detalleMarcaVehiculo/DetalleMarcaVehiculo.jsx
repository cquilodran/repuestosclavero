...
import { editarMarcaVehiculoApi, putActDesMarcaVehiculoApi, getListaMarcaVehiculoApi } from '../../../../../api/marcaVehiculo'





const DetalleMarcaVehiculo = (props) => {
  const { state: { docs }, dispatch } = useContext(ContextMarcaVehiculo)
  ...
  const activarDesactivar = async (id, estado) => {
    const respuesta = await putActDesMarcaVehiculoApi(id, !estado)
...
function EditarRegistro(props) {
  ...
  const onSubmit = values => {
    setLoading(true)
    editarMarcaVehiculoApi(informacion._id, values)
      .then(respuesta => {
        setLoading(false)
...
export default React.memo(DetalleMarcaVehiculo)
